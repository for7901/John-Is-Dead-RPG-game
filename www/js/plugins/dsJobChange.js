...
/*:
 * @plugindesc Job change system ver1.11.5
 * @author Douraku
 *
 * @noteParam faceName
 * @noteRequire 1
 ...
 * @desc Whether to show menu commands
 * @default true
 *
 * @param Command Name
 * @desc Job change command name
 * @default Class Change
 *
 * @param Effect Animation Id
 * @desc Animation ID number for effect
 * @default 52
 *
 * @param Optimize Equip Enable
 * @desc To set the best equip after a job change
 * @default true
 *
 * @param Optimize Equip Text
 * @desc Message for best equip after a job change
 * @default You're well-equipped.
 *
 * @param Keep Exp
 * @desc Whether to keep experience after job change
 * @default false
 *
 * @help
 * This plugin can set the following Note tags.
 *
 * -----------------------------------------------------------------------------
