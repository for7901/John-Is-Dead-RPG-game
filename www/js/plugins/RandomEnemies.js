...
Rexal.RE.SpritesetBattlecreateEnemies = Spriteset_Battle.prototype.createEnemies;

Spriteset_Battle.prototype.createEnemies = function() {
	
	Rexal.RE.SpritesetBattlecreateEnemies.call(this);
	  for (var e = 0; e < this._enemySprites.length; e++) {
	  console.log(this._enemySprites[e]._battlerHue);
	  console.log(this._enemySprites[e]);
	  this._enemySprites[e]._battlerHue += 180;
	  console.log(this._enemySprites[e]._battlerHue);
	  this._enemySprites[e].updateBitmap();
	  }
