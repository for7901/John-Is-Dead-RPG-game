...
var Felski = Felski || {};  
Felski.Techtree = {};
Felski.Techtree.version = 1.37;

/*:
* @plugindesc v1.3.7 A techtree plugin.
* @author Felski
* @help
...
//************************************************************************************************
    ...
    Window_Techtree_Confirm.prototype.drawNodeInfo = function(withRequirement) {
        ...
        for (var i = 0; i < onActivate.skills.length; i++) {
            ...
            if(Felski.Techtree.TTNShowSkillDesc) line = line + this.drawTextAutoWrap(skill.description, x+16, lh*line, (w-ip-16-this.standardPadding()));
        }
